<script lang="ts">
	...
	import { X, Lock, Mail, LogIn, UserPlus, AlertCircle, CheckCircle2 } from '@lucide/svelte';
			...
			<div class="flex items-center gap-2.5">
				...
				<div>
					<h3 class="text-base font-extrabold text-stone-900 font-heading">
						{mode === 'login' ? 'Sign In to BingeTrack' : 'Create an Account'}
					</h3>
					<p class="text-xs text-stone-500 font-medium">Sync your TV watch history across devices</p>
				</div>
			</div>
