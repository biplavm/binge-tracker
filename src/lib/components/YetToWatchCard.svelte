...
<div class="glass-card group relative overflow-hidden rounded-2xl flex flex-row bg-white border border-stone-200 shadow-sm p-4 sm:p-5 gap-3 sm:gap-5">
	...
	<div class="flex-1 flex flex-col justify-between min-w-0 py-1">
		<div>
			...
			<p class="mt-1.5 text-[10px] sm:text-xs text-stone-500 font-medium line-clamp-1">
